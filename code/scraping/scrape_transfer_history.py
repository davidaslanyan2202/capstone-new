...
The script reads unique `trmrkt_player_id` values from data/interim/metrics.csv,
...
DEFAULT_INPUT_PATH = REPO_ROOT / "data" / "interim" / "metrics.csv"
DEFAULT_OUTPUT_DIR = REPO_ROOT / "data" / "scraped" / "transfermarkt" / "history_json"

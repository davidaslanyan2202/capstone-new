...
### Base Table: `data/processed/metrics.csv`
...
### Transfer History: `jsons/*.json`

Each file is named by Transfermarkt player ID:

`jsons/{trmrkt_player_id}.json`
...
### 1. `data/processed/transfer_history_events.csv`
...
### 2. `data/processed/player_season_market_values.csv`
...
### 3. `data/processed/player_season_contract_features.csv`
